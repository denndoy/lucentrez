-- Lucentrez PostgreSQL full migration + seed
-- Source: current Supabase schema/data adapted for plain PostgreSQL
-- Note:
-- 1. This migrates database schema and seed data only.
-- 2. Image assets are still referenced via existing Supabase Storage URLs.
-- 3. Supabase-specific roles/RLS/auth/storage are intentionally omitted for PostgreSQL compatibility.
